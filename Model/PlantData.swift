...
let plantList: [PlantData] = [
    ...
    PlantData(name: "Cabe Rawit",
              ...
              pestControl: ["• Semprot menggunakan air bertekanan untuk meluruhkan hama", "• Semprot tanaman dengan larutan minyak nimba", "• Tanam tanaman yang dapat mengundang pemangsa alami"],
              image: "cabai"
             ),
    ...
    PlantData(name: "Kangkung",
              ...
              pestControl: ["• Lakukan penyiangan rumput liat dan pemberantasan gulma secara berkala setidaknya 2 minggu sekali"],
              image: "kangkung"
             ),
    PlantData(name: "Daun Bawang",
              ...
              hama: ["• Ulat Tanah", "• Ulat Daun", "• Kutu Bawang"],
    ...
    PlantData(name: "Sereh",
              ...
              hama: ["• Penggorok Batang", "Kutu Kebul"],
              pestControl: ["• Tanam tanaman yang dapat mengundang pemangsa alami"],
              image: "sereh"
             ),
