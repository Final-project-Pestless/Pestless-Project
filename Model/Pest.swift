...
let PestList: [PestData] = [
    ...
    PestData(name: "kutuDaun",
             ...
             eat: "",
             plant: ["Kentang", "Lada", "Kubis", "Bayam", "Asparagus", "Mustard", "Terong", "Tomat", "Semangka", "Mentimun"],
    ...
    PestData(name: "belalang",
             ...
             eat: "",
             plant: ["Kembang kol", "Kubis", "Bayam", "Jagung", "Rumput", "Bunga", "Biji"],
    ...
    PestData(name: "kutuKebul",
             ...
             plant: ["Mangga", "Pepaya", "Anggur", "Nanas", "Singkong", "Kaktus", "Tebu", "Pohon Kopi", "Pakis", "Bunga Matahari", "Anggrek"],
    ...
    PestData(name: "kepik",
             ...
             image: ["truebug"],
             biopests: [BiopesticideList[1], BiopesticideList[5]]
            )
             ]
